...
<?php
		...
		{
			$sql="Insert into found(rollno,name,department,email,contact,itemname,description) values('" . $_SESSION['user'] . "', '".mysql_real_escape_string($_POST['username'])."','".$_POST['department']."','".mysql_real_escape_string($_POST['email'])."','". $_POST['contact']."','".mysql_real_escape_string($_POST['item'])."','".mysql_real_escape_string($_POST['desc'])."')";

			mysql_query($sql,$conn) or die(mysql_error()) ;
			$id=mysql_insert_id($conn);
        
			$text="FOUND information Registered Successfully! <br> Go to found list to see your entry.";
